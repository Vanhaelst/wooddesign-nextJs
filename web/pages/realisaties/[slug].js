  ...
  return (
    <div>
      <Head>
        ...
        <meta
          property="og:title"
          content={`Wooddesign - Realisaties - ${realisatie.title}`}
          key="title"
        />
        <meta
          name="keywords"
          content={`${realisatie.details.houtsoort} - ${realisatie.details.type} - ${meta.keywords}`}
        />
      </Head>
      <Navigation />
              ...
              <UnorderedList>
                <ListItem>
                  ...
                  <Text fontFamily="secondary">
                    {realisatie.details.houtsoort}
                  </Text>
                </ListItem>
                <ListItem>
                  <Text fontWeight="bold">Type:&nbsp;</Text>
                  <Text fontFamily="secondary">{realisatie.details.type}</Text>
                </ListItem>
                <ListItem>
                  <Text fontWeight="bold">Totaal:&nbsp;</Text>
                  <Text fontFamily="secondary">{realisatie.details.total}</Text>
                </ListItem>
              </UnorderedList>
            </Details>
          </Grid>
