...
const getPadding = ({ p, pb, pl, pr, pt, px, py }) => {
    ...
    return css`
        ${props => paddingTop && `padding-top: ${props.theme.spaces[paddingTop]}`};
        ${props => paddingRight && `padding-right: ${props.theme.spaces[paddingRight]}`};
        ${props => paddingBottom && `padding-bottom: ${props.theme.spaces[paddingBottom]}`};
        ${props => paddingLeft && `padding-left: ${props.theme.spaces[paddingLeft]}`};
    `
}
