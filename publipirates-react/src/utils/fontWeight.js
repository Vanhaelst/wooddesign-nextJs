...
const fontWeight = css`
  font-weight: 
    ${props => (props.fontWeight === 'inherit' && 'inherit')}
    ${props => (props.fontWeight === 'light' && props.theme.font.weight.light)}
    ${props => (props.fontWeight === 'regular' && props.theme.font.weight.regular)}
    ${props => (props.fontWeight === 'medium' && props.theme.font.weight.medium)}
