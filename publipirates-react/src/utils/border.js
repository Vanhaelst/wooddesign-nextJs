...
const border = css`
  ${props => props.borderColor && `border-color: ${props.borderColor};`}
    ...
    ${props => props.borderBottomWidth && `border-bottom-width: ${props.theme.borders[props.borderBottomWidth]};`}
    ...
    ${props => props.borderLeftWidth && `border-left-width: ${props.theme.borders[props.borderLeftWidth]};`}
    ...
    ${props => props.borderRightWidth && `border-right-width: ${props.theme.borders[props.borderRightWidth]};`}
    ...
    ${props => props.borderTopWidth && `border-top-width: ${props.theme.borders[props.borderTopWidth]};`}
`
